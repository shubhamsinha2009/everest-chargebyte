...
#ifndef INFYPOWER_DCSUPPLY_HPP
#define INFYPOWER_DCSUPPLY_HPP
...
public:
    InfypowerDCSupply() = delete;
    InfypowerDCSupply(const ModuleInfo& info, std::unique_ptr<power_supply_DCImplBase> p_main, Conf& config) :
